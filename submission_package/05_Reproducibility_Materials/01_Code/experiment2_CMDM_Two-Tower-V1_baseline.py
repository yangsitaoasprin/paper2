"""
CMDM-Lab/CYP450 baseline run based on Experiment 2 logic.
...
RESULT_PATH = Path(os.getenv("CMDM_RESULT_PATH", str(RESULT_DIR / "cmdm_experiment2_twotowerv1_result.json")))
MODEL_PATH = Path(os.getenv("CMDM_MODEL_PATH", str(MODEL_DIR / "cmdm_experiment2_twotowerv1_best.pt")))
...
def main() -> None:
    set_seed(SEED)
    print("=" * 70)
    print("CMDM EXPERIMENT 2: Two-Tower V1 + REAL Enzyme Sequences")
    print("=" * 70)
    ...
    print("\n[2/4] Training Two-Tower V1...")
    model = TwoTowerV1().to(DEVICE)
    ...
    result = {
        "experiment": "CMDM Experiment 2: Two-Tower V1 with Real Enzyme Sequences",
